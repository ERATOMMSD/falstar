...
Toplevel = include | define-system | define | push | pop | load | latex | set-solver | select-system | set-repeat | set-seed | clear-seed | set-log | flush-log | clear-log | falsify | estimate | simulate | robustness | quit
